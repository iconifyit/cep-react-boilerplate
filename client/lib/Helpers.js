...
module.exports.tagsFromFileName = tagsFromFileName;
...
module.exports.getSvgDimensions = getSvgDimensions;
...
module.exports.iconMetaFromFile = iconMetaFromFile;
...
module.exports.metaObjectFromIconsFolder = metaObjectFromIconsFolder;
...
module.exports.metaObjectFromIconsList = metaObjectFromIconsList;
...
module.exports.shortUUID = shortUUID;
...
module.exports.ucWords = ucWords;
...
const getStartFolder = (fallback) => {
    ...
    if (! $is.undefined(module.exports.startFolder)) {
        __startFolder = module.exports.startFolder;
    }
...
module.exports.getStartFolder = getStartFolder;
...
module.exports.listFilesRecursively = listFilesRecursively;
...
module.exports.xmlToString = xmlToString;
...
module.exports.trimNewLines = trimNewLines;
...
module.exports.isEnterKey = isEnterKey;
...
module.exports.isDefinedOr = isDefinedOr;
...
module.exports.isEmptyOr = isEmptyOr;
...
module.exports.isErrorString = isErrorString;
...
module.exports.syspath = syspath;
...
module.exports.fs$mkdir = fs$mkdir;
...
module.exports.fs$readjson = fs$readjson;
...
module.exports.fs$storedStartFolder = fs$storedStartFolder;
module.exports.fs$storedStartFolder = fs$storedStartFolder;
...
module.exports.isIconjar = isIconjar;
...
module.exports.host$console = host$console;
...
module.exports.my_eval = my_eval;
...
module.exports.isSupportedArchiveType = isSupportedArchiveType;
...
module.exports.getItemByProperty = getItemByProperty;
...
module.exports.chooseFolderSync = chooseFolderSync;
...
module.exports.host$try = host$try;
...
module.exports.replaceNodeWithReactComponent = replaceNodeWithReactComponent;
...
module.exports.isReservedMethodName = isReservedMethodName;
...
module.exports.bindGlobalThis = bindGlobalThis;
...
module.exports.getGroupFromPath = getGroupFromPath;
...
module.exports.getSetFromPath = getSetFromPath;